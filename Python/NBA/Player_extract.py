...
def career_stats(season_stats,season_type,player_data):
    ...
    for _, season in season_stats.iterrows():
        ...
        try:
            pm = plus_minus(player_id, season_id, season_type)
...
def accolades(awards_df, player_data):
    ...
    for _, award in awards_df.iterrows():
        ...
        elif desc == "Defensive Player of the Year":
...
# === Manually choose the index ===
i = 165  # Change this to the segment number you want (e.g., 0-based index)
...
for player in segment:
    ...
    career = playercareerstats.PlayerCareerStats(player_id, timeout=240)
